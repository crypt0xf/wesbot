...
const features = [
  {
    ...
    description:
      'Spotify, YouTube, Apple Music e Deezer via Lavalink. Filtros, autoplay e playlists salvas.',
  },
  {
  ...
  return (
    <div className="relative isolate flex min-h-screen flex-col">
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="bg-primary/5 absolute left-1/2 top-0 h-[600px] w-[600px] -translate-x-1/2 rounded-full blur-[120px]" />
      </div>
      ...
      <section className="mx-auto flex max-w-4xl flex-1 flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-balance text-lg sm:text-xl">
          Bot de música e moderação para Discord com painel web completo. Gerencie seu servidor de
          onde estiver.
        </p>
      ...
      <footer className="border-border/40 border-t py-6 text-center">
        <p className="text-muted-foreground text-xs">
          ...
          <a href="https://github.com/crypt0xf" className="hover:text-foreground transition-colors">
            crypt0xf
          </a>{' '}
          · MIT License
        </p>
